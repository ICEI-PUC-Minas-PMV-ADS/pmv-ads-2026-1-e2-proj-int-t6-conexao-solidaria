...
namespace ConexaoSolidaria.Migrations
{
    ...
    [Migration("20260610185424_RemovendoTabelaDoacoes")]
    partial class RemovendoTabelaDoacoes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConexaoSolidaria.Models.Avaliacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConexaoSolidaria.Models.GrupoApoio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConexaoSolidaria.Models.Avaliacao", b =>
                {
                    ...
                    b.HasOne("ConexaoSolidaria.Models.OfertaAjuda", "OfertaAjuda")
                        .WithMany()
                        .HasForeignKey("OfertaAjudaId")
            ...
            modelBuilder.Entity("ConexaoSolidaria.Models.MensagemChat", b =>
                {
                    b.HasOne("ConexaoSolidaria.Models.ChatApoio", "ChatApoio")
                        .WithMany("Mensagens")
                        .HasForeignKey("ChatApoioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ConexaoSolidaria.Models.Usuario", "Remetente")
                        .WithMany()
            ...
            modelBuilder.Entity("ConexaoSolidaria.Models.OfertaAjuda", b =>
                {
                    ...
                    b.HasOne("ConexaoSolidaria.Models.Solicitacao", null)
                        .WithMany("OfertasAjuda")
                        .HasForeignKey("SolicitacaoId1");
            ...
            modelBuilder.Entity("ConexaoSolidaria.Models.Solicitacao", b =>
                {
                    b.HasOne("ConexaoSolidaria.Models.Usuario", "Usuario")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ConexaoSolidaria.Models.Usuario", null)
                        .WithMany()
