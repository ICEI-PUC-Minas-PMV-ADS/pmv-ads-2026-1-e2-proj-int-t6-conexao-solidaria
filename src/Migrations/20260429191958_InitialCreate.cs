        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoNecessidade = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    Titulo = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    Descricao = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    Urgencia = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Solicitacoes_Cidade",
                table: "Solicitacoes",
                column: "Cidade");

            migrationBuilder.CreateIndex(
                name: "IX_Solicitacoes_Status_Urgencia_CriadoEm",
                table: "Solicitacoes",
                columns: new[] { "Status", "Urgencia", "CriadoEm" });
