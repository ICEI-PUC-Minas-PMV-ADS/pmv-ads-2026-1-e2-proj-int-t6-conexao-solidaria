...
namespace ConexaoSolidaria.Pages.Grupos;
...
public class NovaModel : PageModel
{
    ...
    public class InputModel
    {
        ...
        [Required(ErrorMessage = "Descreva sua grupo.")]
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        _db.Grupos.Add(grupoo);
        await _db.SaveChangesAsync();

        return RedirectToPage("/Grupos/Detalhes", new { id = grupo.Id });
    }
}
