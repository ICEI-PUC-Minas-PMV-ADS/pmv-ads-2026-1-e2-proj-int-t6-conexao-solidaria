...
| Usuário 2   |           325         |             27                    |  Sim               |  Nenhum                      |       O usuário conseguiu editar com facilidade.                       |      O usuário conseguiu editar com facilidade.               |      
| Usuário 3   |          708          |               52                  |    Sim             |      Se perdeu momentaneamente e precisou redigitar informações.                  |         O usuário conseguiu editar com facilidade moderada.                     |            O usuário conseguiu editar com facilidade moderada.         |  
